...
public class DarkFountainFullMusicSound extends DarkFountainFullSound<DarkFountainFullBlockEntity>{
    private static final float VOLUME_MIN = 0.0F;
    private static final float VOLUME_MAX = 0.4F;

    public DarkFountainFullMusicSound(DarkFountainFullBlockEntity fountain, SoundEvent soundEvent) {
