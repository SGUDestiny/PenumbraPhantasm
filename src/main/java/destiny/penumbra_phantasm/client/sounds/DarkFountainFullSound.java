...
public class DarkFountainFullSound <T extends DarkFountainFullBlockEntity> extends AbstractTickableSoundInstance {
    ...
    public DarkFountainFullSound(T fountain, SoundEvent soundEvent, int fullDistance, int maxDistance) {
    ...
    public void tick()
    {
        if(!(Minecraft.getInstance().level.getBlockEntity(fountainPos) instanceof DarkFountainFullBlockEntity))
            this.stop();
    }
