...
public class GreatDoorClosedModel extends EntityModel<Entity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PenumbraPhantasm.MODID, "great_door_closed_model"), "main");
	...
	public GreatDoorClosedModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition door_right = main.addOrReplaceChild("door_right", CubeListBuilder.create().texOffs(256, 0).mirror().addBox(0.0F, -144.0F, 0.0F, 43.0F, 144.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition door_left = main.addOrReplaceChild("door_left", CubeListBuilder.create().texOffs(256, 0).addBox(-43.0F, -144.0F, 0.0F, 43.0F, 144.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(86.0F, 0.0F, 0.0F));
