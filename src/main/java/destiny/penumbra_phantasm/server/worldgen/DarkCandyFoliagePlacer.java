...
public class DarkCandyFoliagePlacer extends FoliagePlacer {
    public static final Codec<DarkCandyFoliagePlacer> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    ).apply(instance, DarkCandyFoliagePlacer::new));

    public DarkCandyFoliagePlacer(IntProvider pRadius, IntProvider pOffset)
    {
    ...
    protected FoliagePlacerType<?> type() {
        return FeatureRegistry.DARK_CANDY_FOLIAGE.get();
    }
