...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<DarkFountainFullBlockEntity>> DARK_FOUNTAIN_FULL = BLOCK_ENTITIES.register("dark_fountain_full", () -> BlockEntityType.Builder.of(DarkFountainFullBlockEntity::new, BlockRegistry.DARK_FOUNTAIN_FULL.get()).build(null));
}
