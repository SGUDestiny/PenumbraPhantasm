...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> POLISHED_UMBRASTONE_BUTTON = registerBlock("polished_umbrastone_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_MAGENTA).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> POLISHED_UMBRASTONE_PRESSURE_PLATE = registerBlock("polished_umbrastone_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_MAGENTA).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE));
    ...
    public static final RegistryObject<Block> UMBRASTONE_BRICK_BUTTON = registerBlock("umbrastone_brick_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_MAGENTA).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    ...
    public static final RegistryObject<Block> UMBRASTONE_BUTTON = registerBlock("umbrastone_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_MAGENTA).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    ...
    public static final RegistryObject<Block> COBBLED_UMBRASTONE_BUTTON = registerBlock("cobbled_umbrastone_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_MAGENTA).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    ...
    public static final RegistryObject<Block> POLISHED_SCARLET_MARBLE_BUTTON = registerBlock("polished_scarlet_marble_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_RED).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> POLISHED_SCARLET_MARBLE_PRESSURE_PLATE = registerBlock("polished_scarlet_marble_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_RED).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE));
    ...
    public static final RegistryObject<Block> SCARLET_MARBLE_BRICK_BUTTON = registerBlock("scarlet_marble_brick_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_RED).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    ...
    public static final RegistryObject<Block> SCARLET_MARBLE_BUTTON = registerBlock("scarlet_marble_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_RED).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    ...
    public static final RegistryObject<Block> COBBLED_SCARLET_MARBLE_BUTTON = registerBlock("cobbled_scarlet_marble_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_RED).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    ...
    public static final RegistryObject<Block> POLISHED_DARK_MARBLE_BUTTON = registerBlock("polished_dark_marble_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> POLISHED_DARK_MARBLE_PRESSURE_PLATE = registerBlock("polished_dark_marble_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE));
    ...
    public static final RegistryObject<Block> DARK_MARBLE_BRICK_BUTTON = registerBlock("dark_marble_brick_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission(), BlockSetType.STONE, 30, false));
    ...
    public static final RegistryObject<Block> DARK_MARBLE_BUTTON = registerBlock("dark_marble_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_GRAY).noCollission(), BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> DARK_MARBLE_PRESSURE_PLATE = registerBlock("dark_marble_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_GRAY).noCollission(), BlockSetType.STONE));
    ...
    public static final RegistryObject<Block> COBBLED_DARK_MARBLE_BUTTON = registerBlock("cobbled_dark_marble_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_GRAY).noCollission(), BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> COBBLED_DARK_MARBLE_PRESSURE_PLATE = registerBlock("cobbled_dark_marble_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.CALCITE).mapColor(MapColor.COLOR_GRAY).noCollission(), BlockSetType.STONE));
    ...
    //Cliffrock misc
    public static final RegistryObject<Block> CLIFFROCK_PATH = registerBlock("cliffrock_path",
            () -> new Block(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_PILLAR = registerBlock("cliffrock_pillar",
            () -> new RotatedPillarBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CHISELED_CLIFFROCK = registerBlock("chiseled_cliffrock",
            () -> new Block(CLIFFROCK_PROPERTIES));

    //Polished cliffrock
    public static final RegistryObject<Block> POLISHED_CLIFFROCK = registerBlock("polished_cliffrock",
            () -> new Block(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> POLISHED_CLIFFROCK_STAIRS = registerBlock("polished_cliffrock_stairs",
            () -> new StairBlock(BlockRegistry.POLISHED_CLIFFROCK.get().defaultBlockState(), CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> POLISHED_CLIFFROCK_SLAB = registerBlock("polished_cliffrock_slab",
            () -> new SlabBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> POLISHED_CLIFFROCK_WALL = registerBlock("polished_cliffrock_wall",
            () -> new WallBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> POLISHED_CLIFFROCK_BUTTON = registerBlock("polished_cliffrock_button",
            () -> new ButtonBlock(CLIFFROCK_PROPERTIES, BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> POLISHED_CLIFFROCK_PRESSURE_PLATE = registerBlock("polished_cliffrock_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, CLIFFROCK_PROPERTIES, BlockSetType.STONE));

    //Cliffrock bricks
    public static final RegistryObject<Block> CLIFFROCK_BRICKS = registerBlock("cliffrock_bricks",
            () -> new Block(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_BRICK_STAIRS = registerBlock("cliffrock_brick_stairs",
            () -> new StairBlock(BlockRegistry.CLIFFROCK_BRICKS.get().defaultBlockState(), CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_BRICK_SLAB = registerBlock("cliffrock_brick_slab",
            () -> new SlabBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_BRICK_WALL = registerBlock("cliffrock_brick_wall",
            () -> new WallBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_BRICK_BUTTON = registerBlock("cliffrock_brick_button",
            () -> new ButtonBlock(CLIFFROCK_PROPERTIES, BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> CLIFFROCK_BRICK_PRESSURE_PLATE = registerBlock("cliffrock_brick_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, CLIFFROCK_PROPERTIES, BlockSetType.STONE));

    //Cliffrock
    public static final RegistryObject<Block> CLIFFROCK = registerBlock("cliffrock",
            () -> new Block(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_STAIRS = registerBlock("cliffrock_stairs",
            () -> new StairBlock(BlockRegistry.CLIFFROCK.get().defaultBlockState(), CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_SLAB = registerBlock("cliffrock_slab",
            () -> new SlabBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_WALL = registerBlock("cliffrock_wall",
            () -> new WallBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> CLIFFROCK_BUTTON = registerBlock("cliffrock_button",
            () -> new ButtonBlock(CLIFFROCK_PROPERTIES, BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> CLIFFROCK_PRESSURE_PLATE = registerBlock("cliffrock_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, CLIFFROCK_PROPERTIES, BlockSetType.STONE));

    //Cobbled cliffrock
    public static final RegistryObject<Block> COBBLED_CLIFFROCK = registerBlock("cobbled_cliffrock",
            () -> new Block(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> COBBLED_CLIFFROCK_STAIRS = registerBlock("cobbled_cliffrock_stairs",
            () -> new StairBlock(BlockRegistry.COBBLED_CLIFFROCK.get().defaultBlockState(), CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> COBBLED_CLIFFROCK_SLAB = registerBlock("cobbled_cliffrock_slab",
            () -> new SlabBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> COBBLED_CLIFFROCK_WALL = registerBlock("cobbled_cliffrock_wall",
            () -> new WallBlock(CLIFFROCK_PROPERTIES));
    public static final RegistryObject<Block> COBBLED_CLIFFROCK_BUTTON = registerBlock("cobbled_cliffrock_button",
            () -> new ButtonBlock(CLIFFROCK_PROPERTIES, BlockSetType.STONE, 30, false));
    public static final RegistryObject<Block> COBBLED_CLIFFROCK_PRESSURE_PLATE = registerBlock("cobbled_cliffrock_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, CLIFFROCK_PROPERTIES, BlockSetType.STONE));
